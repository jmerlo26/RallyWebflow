...
const scripts = [
  ...
  {
    type: 'code',
    body: 'WebFont.load({google:{families:["Changa One:400,400italic","Inconsolata:400,700","Bitter:400,700,400italic","Cormorant Garamond:300,300italic,regular,italic,500,500italic,600","Roboto:300,300italic,regular,italic,500,500italic,700,700italic,900"]}});',
    isAsync: false,
  },
  {
    type: 'code',
